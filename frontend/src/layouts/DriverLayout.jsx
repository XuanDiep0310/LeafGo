...
import { Car, BarChart3, History, User, LogOut, Leaf } from "lucide-react"
...
export default function DriverLayout() {
  ...
  const menuItems = [
    { path: "/driver/workplace", icon: Car, label: "Làm việc" },
    { path: "/driver/dashboard", icon: BarChart3, label: "Thống kê" },
    { path: "/driver/history", icon: History, label: "Lịch sử" },
    { path: "/driver/profile", icon: User, label: "Tài khoản" },
  ]
