  ...
  const fetchStats = async () => {
    try {
      ...
      setStats({
        ...
        ThisMonthEarnings:
          data?.ThisMonthEarnings || data?.thisMonthEarnings || 0,
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <Card>
        ...
        {/* Thông tin xe */}
        <h4 className="font-semibold text-foreground mb-3">Thông tin xe</h4>
        ...
        {existingVehicle ? (
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <div className="text-sm text-green-800 space-y-1">
              <p>- Loại xe: {existingVehicle.vehicleType?.name || "N/A"}</p>
              <p>- Biển số: {existingVehicle.licensePlate || "N/A"}</p>
              <p>
                - Hãng & mẫu: {existingVehicle.vehicleBrand || "N/A"}{" "}
                {existingVehicle.vehicleModel || ""}
              </p>
              <p>- Màu xe: {existingVehicle.vehicleColor || "N/A"}</p>
            </div>
          </div>
        ) : (
